    ...
    <>
      <div className="text-center py-16 md:py-24">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className="w-full sm:w-auto bg-white/80 backdrop-blur-lg border border-stone-300 text-stone-700 font-bold py-3 px-8 rounded-lg hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition text-lg"
          >
            I have an account
          </button>
        </div>
      ...
      <div className="py-16 md:py-24">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-stone-800">Why You'll Love Gemini Eats</h2>
